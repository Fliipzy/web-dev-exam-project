                    ...
                    <div class="row">
                                ...
                                <select id="country" name="country">
                                    <option selected hidden>
                                        ...
                                        if (!is_null($_SESSION["customer"]["Country"])) {
                                            echo $_SESSION["customer"]["Country"];
                                        }
                                        else {
                                            echo "Choose here";
                                        }
                        ...
                        <div class="col col-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="city" value="<?php echo $_SESSION["customer"]["City"] ?>" required>
                            </div>
                        </div>
                        <div class="col col-2">
                            <div class="input-group">
                                <label class="required" class="postalCode" for="city">Postal code</label>
                                <input type="tel" name="postalCode" value="<?php echo $_SESSION["customer"]["PostalCode"] ?>" required>
                            </div>
                        </div>
                    </div>
